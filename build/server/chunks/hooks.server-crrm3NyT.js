...
import { g as getSession, a as getUserById, l as logout } from './auth-CkYXVrx8.js';
    ...
    if (session) {
      ...
      if (fetchedUser) {
        user = {
          ...
          profile_image: fetchedUser.profile_image_url
...
export { handle };
//# sourceMappingURL=hooks.server-crrm3NyT.js.map
