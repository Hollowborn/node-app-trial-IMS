import { q as push, B as store_get, P as copy_payload, Q as assign_payload, E as unsubscribe_stores, M as bind_props, u as pop, S as ensure_array_like, O as stringify, F as escape_html, z as attr, I as spread_props, V as props_id, J as spread_attributes } from './index-C7g5K6pr.js';
import './client--FX0Csju.js';
import { w as writable } from './exports-C8zAyQJJ.js';
import { P as Provider, R as Root } from './index3-CWUAYMpH.js';
import { B as Button, b as buttonVariants } from './button-CTUnD44E.js';
...
import { R as Root$1, a as Alert_dialog_content, b as Alert_dialog_header, c as Alert_dialog_title, d as Alert_dialog_description, e as Alert_dialog_footer } from './index6-BARiXcRc.js';
...
import { k as DialogTriggerState, A as AlertDialogCancelState, l as DialogActionState } from './popper-layer-force-mount-CN4ObkAy.js';
...
const allThemes = [
  {
    ...
    // Primary from your :root block
  },
  {
    name: "Tangerine",
    value: "tangerine",
    primaryColor: "oklch(0.6397 0.1720 36.4421)"
    // Primary from your html[data-theme="autumn-gold"] block
  },
  {
    name: "Minimal Blue",
    value: "blue",
    primaryColor: "oklch(0.5461 0.2152 262.8809)"
    // Replace with actual retro primary if you create it
  },
  {
    name: "Ocean Breeze",
    value: "ocean",
    primaryColor: "oklch(0.7227 0.192 149.5793)"
    // Replace with actual ocean primary if you create it
  },
  {
  ...
  // Add more themes here as you create them in app.css
];
const initialCustomTheme = "default";
const customTheme = writable(initialCustomTheme);
customTheme.subscribe((value) => {
});
function setCustomTheme(themeName) {
  customTheme.set(themeName);
}
function _page($$payload, $$props) {
  push();
  var $$store_subs;
  let data = $$props["data"];
  let displayUsername = data.user.username;
  ...
  if (store_get($$store_subs ??= {}, "$currentUser", currentUser).username !== displayUsername) {
    displayUsername = store_get($$store_subs ??= {}, "$currentUser", currentUser).username;
  }
  if (store_get($$store_subs ??= {}, "$currentUser", currentUser).profileImage !== profileImagePreviewUrl) {
    profileImagePreviewUrl = store_get($$store_subs ??= {}, "$currentUser", currentUser).profileImage;
    profileImageFile = null;
    removeProfileImageFlag = false;
  }
      ...
      children: ($$payload3) => {
        ...
        Card_content($$payload3, {
          children: ($$payload4) => {
            ...
            $$payload4.out += `<!--]--> <input type="hidden" name="currentImagePath"${attr("value", store_get($$store_subs ??= {}, "$currentUser", currentUser).profileImage || "")}/> `;
            ...
            Input($$payload4, {
              id: "displayName",
              name: "displayName",
              placeholder: data.user.display_name,
              maxlength: 20
            });
            $$payload4.out += `<!----></div> `;
            Button($$payload4, {
...
//# sourceMappingURL=_page.svelte-CBd5Lrla.js.map
