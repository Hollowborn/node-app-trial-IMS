...
function _page($$payload, $$props) {
  ...
  let filteredFeedItems = data.feedItems?.filter((item) => item.feed_name.toLowerCase().includes(searchQuery.toLowerCase()) || item.feed_stage.toLowerCase().includes(searchQuery.toLowerCase()) || item.requested_by_name.toLowerCase().includes(searchQuery.toLowerCase())) || [];
                              ...
                              children: ($$payload8) => {
                                Badge($$payload8, {
                                  ...
                                  children: ($$payload9) => {
                                    ...
                                    $$payload9.out += `<!----> ${escape_html(item.requested_by_name)}`;
                                  },
                                  $$slots: { default: true }
                                });
                              },
              ...
              children: ($$payload5) => {
                ...
                Root$2($$payload5, {
                  ...
                  children: ($$payload6) => {
                    Select_trigger($$payload6, {
                      children: ($$payload7) => {
                        $$payload7.out += `<span>${escape_html(data.employees.find((e) => e.id === createRequestedBy)?.name || "Select employee")}</span>`;
                      },
                      $$slots: { default: true }
                    });
                    $$payload6.out += `<!----> `;
              ...
              children: ($$payload5) => {
                ...
                Root$2($$payload5, {
                  ...
                  children: ($$payload6) => {
                    Select_trigger($$payload6, {
                      children: ($$payload7) => {
                        $$payload7.out += `<span>${escape_html(data.employees.find((e) => e.id === editRequestedBy)?.name || "Select employee")}</span>`;
                      },
                      $$slots: { default: true }
                    });
                    $$payload6.out += `<!----> `;
...
//# sourceMappingURL=_page.svelte-CeHKDHGD.js.map
